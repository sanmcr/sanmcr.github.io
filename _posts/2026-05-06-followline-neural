---
layout: post
title: "End-to-End Visual Control con PilotNet – Unibotics"
date: 2026-05-06
thumbnail: "/images/net.png"
excerpt: "Conducción autónoma end-to-end mediante Deep Learning utilizando PilotNet y ONNX en Unibotics, comparando este enfoque con un controlador clásico basado en visión artificial y PID."
published: true
---
...
1. El coche obtiene una imagen de la cámara frontal
2. La imagen es preprocesada
3. Se realiza inferencia mediante la red neuronal
4. El modelo predice `V` y `W`
5. Dichas velocidades son enviadas directamente al vehículo
